...
// const Canvas = ({ data, query, chartType, chartConfig }) => {
//   const [scale, setScale] = useState(1);
//   const [chartPosition, setChartPosition] = useState({ x: 20, y: 20 });
//   const [chartSize, setChartSize] = useState({ width: 800, height: 400 });
//   const zoomSpeed = 0.005;
//   const containerRef = useRef(null);
//   const chartContainerRef = useRef(null);
  
//   // Memoize chart component to prevent reloading on zoom
//   const chartComponent = useMemo(() => {
//     const requestPayload = {
//       id_datasource: data?.id_datasource || 1,
//       query: query,
//       chartType: chartType,
//       name: chartConfig?.title || "Visualisasi Data"
//     };
...
//       <DataTableComponent data={data} query={query} />
//     );
//   }, [data, query, chartType, chartConfig]);

//   // Create a debounced save function
//   const saveChartPosition = useMemo(
//     () => debounce((position, size) => {
//       if (!query) return;
      
//       axios.post(`${config.API_BASE_URL}/api/kelola-dashboard/save-chart`, {
//         id_canvas: 1,
//         id_datasource: data?.id_datasource || 1,
//         name: chartConfig?.title || "Visualisasi Data",
...
//       });
//     }, 500),
//     [query, chartType, chartConfig, data]
//   );
...
//   // Save chart position and size on initial load
//   useEffect(() => {
//     if (query && chartType) {
//       saveChartPosition(chartPosition, chartSize);
//     }
//   }, [query, chartType]);

//   // Initialize interact.js for dragging and resizing
//   useEffect(() => {
//     if (!chartContainerRef.current || !query) return;

//     const element = chartContainerRef.current;
//     const canvasElement = containerRef.current?.querySelector('.canvas');
    
//     // Initialize position
//     let { x, y } = chartPosition;
...
//             saveChartPosition(newPosition, { width, height });
//           }
//         }
//       })
//       .resizable({
...
//             saveChartPosition(newPosition, newSize);
//           }
//         }
//       });
...
//     };
//   }, [chartContainerRef.current, query, saveChartPosition]);
