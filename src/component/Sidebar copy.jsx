...
const Sidebar = () => {
  ...
  const [userAccessLevel, setUserAccessLevel] = useState('view'); // Default ke 'view'
  ...
  useEffect(() => {
    ...
    if (!sidebarData || !sidebarDiagram || !sidebarQuery || !sidebarCanvas || !menuData || !menuVisualisasi) return;
  ...
  const handleVisualizationSelect = (visualization) => {
    // User 'view' tidak bisa memilih (mengedit) visualisasi
    if (userAccessLevel === 'view') return;
